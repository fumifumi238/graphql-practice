...
export type TodoEventSubscription = { __typename?: 'Subscription', todoEvents: { __typename?: 'TodoEvent', type: TodoEventType, todo: { __typename?: 'Todo', id: string, title: string, completed: boolean } } };
